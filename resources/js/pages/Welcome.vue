...
<template>
  ...
  <div
    class="relative z-10 flex min-h-screen flex-col items-center bg-transparent p-6 text-[#1b1b18] lg:justify-center lg:p-8"
  >
    <header
      ...
      <nav class="flex items-center justify-end gap-4">
        ...
        <template v-else>
          ...
          <Button v-else as-child>
            <Link :href="suInstaller.index()"> Instalar </Link>
          </Button>
        </template>
      </nav>
    </header>
      ...
      >
        ...
        >
          ...
          <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
            Plantilla para desarrollar aplicaciones web.
            <br />Construida con las siguientes herramientas.
          </p>
            ...
            >
              ...
              <span>
                <a
                  ...
                  target="_blank"
                  class="ml-1 inline-flex items-center space-x-1 font-medium text-sky-700 underline underline-offset-4 dark:text-sky-500"
                >
