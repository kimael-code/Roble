...
const modalConfig = computed<{
  ...
  if (props.twoFactorEnabled) {
    return {
      ...
      description:
        'La autenticación de dos factores está ahora activada. Escanee el código QR o ingrese la clave de configuración en su aplicación de autenticación.',
      buttonText: 'Cerrar',
    };
  }
  ...
  return {
    ...
    description:
      'Para terminar de activar la autenticación de dos factores, escanee el código QR o ingrese la clave de configuración en su aplicación de autenticación',
    buttonText: 'Continuar',
  };
});
